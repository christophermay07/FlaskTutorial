...
Traceback (most recent call last):
  ...
  File "FlaskTutorial/app/routes.py", line 1, in <module>
    from app import app
ImportError: cannot import name 'app' from partially initialized module 'app' (most likely due to a circular import) (/home/chmay/src/scratch/FlaskTutorial/app/__init__.py)
----